...
window.__US_EMP_NOTES__ = {
  '2026-08': {
    rel: '2026-09-04', first: 162, cons: 53,
    head: '컨센서스의 세 배를 넘긴 반등. 다만 3개월 평균은 여전히 7만 명대입니다.',
    pts: [
      '레저·접객이 +62천으로 헤드라인을 끌어올렸습니다. 감소한 업종은 정보(−23천)와 금융(−11천) 둘뿐이었습니다.',
      '7월이 −23천에서 +21천으로 상향 개정됐습니다. 지난달의 "감소 전환" 서사가 한 달 만에 뒤집혔습니다.',
      '실업률은 4.1%로 유지됐지만 참가율이 61.4% → 61.6%로 올랐습니다. 지난 두 달과 달리 노동시장 이탈이 만든 착시가 아닙니다.',
      'U-6가 7.9% → 7.7%로 내렸고, 경제적 사유 시간제 취업자가 402천 명 줄었습니다.',
      '시간당임금은 $37.75(전월비 +0.3%), 전년비 3.1%로 완만한 흐름을 이어갔습니다.',
      '3개월 평균은 71천 명. 한 달 반등이지 추세 전환으로 보기엔 이릅니다.',
    ],
    src: [['CNBC — Jobs report August 2026', 'https://www.cnbc.com/2026/09/04/jobs-report-august-2026.html'],
          ['BLS Employment Situation (M08)', 'https://www.bls.gov/news.release/archives/empsit_09042026.htm']],
  },
  '2026-07': {
