...
# BOK 표의 항목(공백·괄호 제거 후) → 표시명
#
# 자산운용(MMF·채권형·주식형·혼합형)을 여기서 받는 이유:
#   FREESIS 의 '유형별 기간설정' 화면에서 공모/사모 국내 단기금융을 합쳐도
#   협회 자신의 'MMF현황' 및 한국은행 수치와 맞지 않는다 (2026-08-27 기준
#   합산 2,567,331 vs 공표 2,601,793, 3.4조 차이). 화면마다 MMF 정의가 달라서다.
#   ※ 해외분 누락으로 짐작했으나 확인 결과 아니었다 — 협회 MMF현황 자체가
#     유형별 화면과 다른 집계다. 근본 해결은 MMF현황 엔드포인트를 쓰는 것이고,
